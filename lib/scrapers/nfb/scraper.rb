class Scrapers::Nfb::Scraper < Scrapers::ContractScraper
  ...
  def self.reports
    reports = Scrapers::ReportUrlExtractor.new("http://onf-nfb.gc.ca/en/about-the-nfb/publications/proactive-disclosure/", "nfb", "Please select a report").reports
    # Remove other types of reports
    reports.delete_if {|report| report.url.match(/proactive-disclosure-of-contracts/).nil?}
  end
end
