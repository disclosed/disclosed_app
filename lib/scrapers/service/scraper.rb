class Scrapers::Service::Scraper < Scrapers::ContractScraper
  ...
  def self.reports
    Scrapers::ReportUrlExtractor.new("http://disclosure.servicecanada.gc.ca/dp-pd/prdlstcdn-eng.jsp?site=3&section=2", "service", "Disclosure of Contracts Over $10,000", "h1").reports
  end
end
