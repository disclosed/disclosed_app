class Scrapers::Nrc::Scraper < Scrapers::ContractScraper
  BASE_URL = "http://www.nrc-cnrc.gc.ca"
  ...
  def contract_urls
    ...
    page.xpath('//table//caption[contains(., "Contracts over $10,000")]//..//td/a').map {|a_tag| "#{BASE_URL}#{a_tag['href']}" }
  end
