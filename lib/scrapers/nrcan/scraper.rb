class Scrapers::Nrcan::Scraper < Scrapers::ContractScraper
  ...
  def self.reports
    Scrapers::ReportUrlExtractor.new("http://www2.nrcan.gc.ca/dc-dpm/index.cfm?fuseaction=r.q&lang=eng", "nrcan", "Reports", "h1").reports
  end
end
